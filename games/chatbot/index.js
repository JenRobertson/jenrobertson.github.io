...
function getHappyShow() {
  ...
  const programmeLink = "https://www.bbc.co.uk/iplayer/episode/b08w8gfq/peter-kays-comedy-shuffle-series-2-episode-1";
...
function getCalmingShow() {
  ...
  const programmeLink = "https://www.bbc.co.uk/iplayer/episode/b087y9wf/planet-earth-ii-a-world-of-wonder";
...
function getSadShow() {
  ...
  const programmeLink = "https://www.bbc.co.uk/iplayer/episode/b08wzctf/broken-series-1-episode-5";
...
function getCurrentShow(channel){
  ...
  const programmeLink = "https://www.bbc.co.uk/bbcone";
...
[
  ...
  },
  {
    ...
    message: 'My favourite programme is <a href="https://www.bbc.co.uk/iplayer/episode/p04sxvgw/can-a-robot-replace-ed-sheeran">\'Can A Robot Replace Ed Sheeran?\'</a>'
  },
  {
  ...
  },
  {
    ...
    message: "Poldark was directed by Joss Agnew. Here's the <a href='https://www.bbc.co.uk/programmes/b08vh083/credits'>full credits</a>."
  },
  {
